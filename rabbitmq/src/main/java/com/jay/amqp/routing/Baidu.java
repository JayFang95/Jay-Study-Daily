...
public class Baidu {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        channel.queueBind(MqUtils.BAIDU_QUEUE_NAME, MqUtils.WEATHER_ROUTING_EXCHANGE, "BJ");
        channel.queueBind(MqUtils.BAIDU_QUEUE_NAME, MqUtils.WEATHER_ROUTING_EXCHANGE, "SH");
        channel.queueBind(MqUtils.BAIDU_QUEUE_NAME, MqUtils.WEATHER_ROUTING_EXCHANGE, "GZ");
